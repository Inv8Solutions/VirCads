...
export class Scene3 extends Scene
{
    ...
    create ()
    {
        ...
        this.hiddenHitbox.on('pointerdown', (pointer: Phaser.Input.Pointer) => {
            console.log(`[Scene3] Hidden hitbox 1 clicked at x: ${pointer.x}, y: ${pointer.y}`);
            this.showReqForm();
        });
        ...
        this.hiddenHitbox2.on('pointerdown', (pointer: Phaser.Input.Pointer) => {
            console.log(`[Scene3] Hidden hitbox 2 clicked at x: ${pointer.x}, y: ${pointer.y}`);
        ...
        this.background.on('pointerdown', (pointer: Phaser.Input.Pointer) => {
            console.log(`[Scene3] Background click at x: ${pointer.x}, y: ${pointer.y}`);
        });
