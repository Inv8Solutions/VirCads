...
export class Scene29 extends Scene {
    ...
    create() {
        ...
        const continueText = this.add.text(panelX, panelY + panelH/2 - 36, 'Click here to continue', { fontSize: '24px', color: '#ffffff', backgroundColor: 'rgba(0,0,0,0.9)', padding: { x: 20, y: 12 } }).setOrigin(0.5).setDepth(52);
