...
export class Scene63 extends Scene {
    ...
    create() {
        ...
        const okBtn = this.add.rectangle(okX, okY, 140, 48, 0x000000).setDepth(262).setInteractive({ useHandCursor: true });
